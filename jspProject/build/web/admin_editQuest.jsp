        ...
        <table border="0">
            ...
            <tr>
                <td style="text-align: center">
                    <form action="http://localhost:8084/jspProject/Admincon?index=11" method="post">
                        ...
                        <table border="0">
                            <tr>
                                ...
                                <td colspan="4"><textarea required  name="squestion" rows="6" cols="60" style="resize: none"><%=question[questno][1]%></textarea></td>
                            </tr>
                            <tr>
                                <td width="10px">A</td>
                                <td><textarea required  name="answera" rows="3" cols="26" style="resize: none"><%=question[questno][2].substring(3)%></textarea></td>
                                <td width="10px">C</td>
                                <td><textarea required  name="answerc" rows="3" cols="26" style="resize: none"><%=question[questno][4].substring(3)%></textarea></td>
                            
                            </tr>
                            <tr>
                                <td width="10px">B</td>
                                <td><textarea required  name="answerb" rows="3" cols="26" style="resize: none"><%=question[questno][3].substring(3)%></textarea></td>
                                <td width="10px">D</td>
                                <td><textarea required  name="answerd" rows="3" cols="26" style="resize: none"><%=question[questno][5].substring(3)%></textarea></td>
                            
                            </tr>
                            <tr>
                                <td>Answer</td>
                                <td colspan="4"><textarea required  name="sanswer" rows="1" cols="60" style="resize: none"><%=question[questno][6]%></textarea></td>
                            </tr>
                            <tr>
                               <td colspan="5" style="padding-left: 50px">
                        <center>
                            <input type="submit" value="Edit" class="button">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="button" type="reset" value="Reset">
                        </center>
